...
public class ItemMapper {
    ...
    public static Item mapItemFromCreateReq(ItemRequestDto itemRequestDto) {
        Item item = new Item();
    ...
    public static Item mapItemFromUpdateReq(Item item, ItemRequestDto itemRequestUpdate) {
